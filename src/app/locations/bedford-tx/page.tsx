...
export const metadata: Metadata = {
  ...
  description: 'Window services in Bedford, TX. Professional installation and replacement for Bedford homes. Energy-efficient windows, expert service.',
  keywords: 'window replacement Bedford TX, Bedford window installation',
}
    ...
    <main>
      ...
      <section className="relative pt-20 lg:pt-28 pb-20 lg:pb-24 bg-navy-600">
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 lg:px-10">
          <div className="max-w-3xl">
            <h1 className="font-serif text-4xl lg:text-6xl text-white mb-6 leading-tight">Window Services in Bedford, Texas</h1>
            <p className="text-lg lg:text-xl text-white/90 leading-relaxed mb-8">
              Window Replacements of Frisco serves Bedford with professional window installation and replacement. Our expertise covers Bedford&apos;s neighborhoods with quality window solutions.
            </p>
      ...
      <section className="py-20 lg:py-28 bg-cream-100">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-10">
          <h2 className="font-serif text-3xl lg:text-5xl text-navy-600 text-center mb-12">Trusted in Bedford</h2>
          <p className="text-lg text-gray-600 text-center max-w-3xl mx-auto mb-12">
            Bedford&apos;s communities deserve quality window services. We provide installations and replacements that enhance your home&apos;s comfort and value.
          </p>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8">
              <h3 className="font-serif text-xl text-navy-600 mb-3">Window Replacement</h3>
              <p className="text-gray-600">Upgrade your Bedford home with energy-efficient windows.</p>
            </div>
            <div className="bg-white p-8">
      ...
      <section className="py-20 lg:py-24 bg-navy-600">
        <div className="max-w-[1000px] mx-auto px-6 lg:px-10 text-center">
          <h2 className="font-serif text-3xl lg:text-5xl text-white mb-6">Quality Windows for Bedford Homes</h2>
          <p className="text-lg text-white/90 mb-10">Contact us today for expert window services in Bedford.</p>
